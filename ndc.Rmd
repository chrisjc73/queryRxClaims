...
```{r}
ndcLookupA <- ndcMaster[grep("beta.+blocker", pharm_classes, ignore.case=TRUE)]
...
ndcLookupA[grep("^(carbonic|increased|(adrenergic alpha-ag))", pharm_classes, ignore.case=TRUE),
           .N,
           list(substr(pharm_classes, 1, 20), substancename)]
```
